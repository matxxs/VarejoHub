...
namespace VarejoHub.Infrastructure.Migrations
{
    ...
    [Migration("20251002203145_InitialCreateWithSeed")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.Assinatura", b =>
                {
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.Cliente", b =>
                {
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.Fatura", b =>
                {
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.Fornecedor", b =>
                {
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.ItemVenda", b =>
                {
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.MovimentacaoEstoque", b =>
                {
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.Plano", b =>
                {
                    b.Property<int>("IdPlano")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.Produto", b =>
                {
                    b.Property<int>("IdProduto")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.Supermercado", b =>
                {
                    b.Property<int>("IdSupermercado")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.TransacaoFinanceira", b =>
                {
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.Usuario", b =>
                {
                    b.Property<int>("IdUsuario")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.Venda", b =>
                {
                    b.Property<int>("IdVenda")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.Assinatura", b =>
                {
                    b.HasOne("VarejoHub.Domain.Entities.Plano", "Plano")
                        .WithMany("Assinaturas")
                        .HasForeignKey("IdPlano")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VarejoHub.Domain.Entities.Supermercado", "Supermercado")
                        .WithOne("Assinatura")
                        .HasForeignKey("VarejoHub.Domain.Entities.Assinatura", "IdSupermercado")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.Fatura", b =>
                {
                    b.HasOne("VarejoHub.Domain.Entities.Assinatura", "Assinatura")
                        .WithMany("Faturas")
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.ItemVenda", b =>
                {
                    b.HasOne("VarejoHub.Domain.Entities.Produto", "Produto")
                        .WithMany("ItensVenda")
                        .HasForeignKey("IdProduto")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("VarejoHub.Domain.Entities.Venda", "Venda")
                        .WithMany("Itens")
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.LogAuditoria", b =>
                {
                    ...
                    b.HasOne("VarejoHub.Domain.Entities.Usuario", "Usuario")
            ...
            modelBuilder.Entity("VarejoHub.Domain.Entities.Venda", b =>
                {
                    b.HasOne("VarejoHub.Domain.Entities.Cliente", "Cliente")
                        .WithMany("Compras")
                    ...
                    b.HasOne("VarejoHub.Domain.Entities.Usuario", "UsuarioCaixa")
